...
class MHSA(nn.Module):
    def __init__(self, dim_in, dim, A, num_heads=6, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., insert_cls_layer=0, pe=False, num_point=11,
                 outer=True, layer=0,
                 **kwargs):
        super().__init__()
...
class unit_vit(nn.Module):
    def __init__(self, dim_in, dim, A, num_of_heads, add_skip_connection=True,  qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                ...
                insert_cls_layer=0, pe=False, num_point=11, **kwargs):
        super().__init__()
...
class TCN_ViT_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, stride=1, num_of_heads=6, residual=True, kernel_size=5, dilations=[1,2], pe=False, num_point=11, layer=0):
...
class Hyperformer_Model(nn.Module):
    def __init__(self, cfg, num_class=60, num_point=25, num_person=1, graph=None, graph_args=dict(), in_channels=3,
        ...
        # self.joint_label = [0 for _ in range(25)]

        # self.input_projection = nn.Linear(11, 25)
    ...
    #     self._freeze_core_layers()
    
    # def _freeze_core_layers(self):
    #     """Freeze all core layers (l1 to l10)"""
    #     for i in range(1, 11):
    ...
    def forward(self, x): #y
        ...
        # x = self.input_projection(x)  # N, M, T, V
